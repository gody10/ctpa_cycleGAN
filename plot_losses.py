...
def parse_log_file(log_path):
    """Parses the CycleGAN train_log.txt to extract loss metrics."""
    ...
    # Matches: "Epoch 5 - Val Loss: 0.123456"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, required=True, help="Name of the experiment (e.g., coltea_cyclegan)")
